...
-(void)ReloadImageProgressWithUrl:(NSString*)url complition:(void (^) (void))complition;
/**
...
- (void)setImageAndProgressViewWithURL:(NSString*)url withLargeProgressView:(BOOL)isLarge forView:(UIView*)view withIndicatorColor:(UIColor*)color;
