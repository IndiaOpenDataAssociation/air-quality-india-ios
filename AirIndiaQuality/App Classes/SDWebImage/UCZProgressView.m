...
- (void)commonInit {
    ...
    self.lineWidth = 3.0;
    self.tintColor = [UIColor colorWithRed:1.0 green:172.0/255 blue:62.0/255 alpha:1.0];
    self.radius = 20.0;
...
- (UIView *)defaultBackgroundView {
    ...
    backgroundView.backgroundColor = [UIColor colorWithRed:40.0/255 green:49.0/255 blue:69.0/255 alpha:0.6];
...
- (void)layoutTextLabel {
    ...
    if (!self.textLabel.hidden) {
        self.textLabel.textColor = [UIColor whiteColor]; //self.textColor ?: self.tintColor;
