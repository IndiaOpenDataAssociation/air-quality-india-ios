...
//        popupView.layer.shadowOpacity = 0.5
    ...
    func btnDismissViewControllerWithAnimation(btnDismiss : UIButton) {
        ...
        switch animationType {
        case .BottomTop, .BottomBottom, .TopTop, .TopBottom, .LeftLeft, .LeftRight, .RightLeft, .RightRight:
            appDelegate.window?.rootViewController!.dismissPopupViewController(animationType)
        default:
    ...
    func dismissPopupViewController(animationType: SLpopupViewAnimationType) {
        ...
        switch animationType {
        case .BottomTop, .BottomBottom, .TopTop, .TopBottom, .LeftLeft, .LeftRight, .RightLeft, .RightRight:
            appDelegate.window?.rootViewController!.slideViewOut(popupView, sourceView: sourceView, overlayView: overlayView, animationType: animationType)
        default:
